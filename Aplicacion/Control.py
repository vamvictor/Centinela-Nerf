...
class Nerf_App(QWidget):    #clase de control y menu
    ...
    def __init__(self):
        ...
        self.turno_robot = True             #turno del robot del modo jugar
        ...
        self.turno_button = self.ui.turno_button                 #boton de turno, indicativo
    ...
    def jugar_on(self):
        ...
        if self.modo_jugar == True:
            ...
            self.motor_on = True
            self.turno_robot = True
            self.turno_button.setEnabled(True)
            self.turno_button.setIcon(QIcon('GUI/turno_off.png'))
        ...
        #no hay modo jugar, motores on por defecto, se puede disparar
            ...
            self.motor_on_button.setEnabled(True)
            self.motor_on_button.setChecked(True)
            self.turno_button.setEnabled(False)
    ...
    def mouseMoveEvent(self, event):
        if self.modo_centinela == False and (self.modo_jugar == False or self.turno_robot == False):
    ...
    def mousePressEvent(self, event):
        if self.modo_centinela == False and (self.modo_jugar == False or self.turno_robot == False):
            ...
            if self.on_pad and self.motor_on:
                ...
                self.disparar_button.setEnabled(False)
                self.turno_robot = True
                self.turno_button.setChecked(False)
                self.turno_button.setIcon(QIcon('GUI/turno_off.png'))
