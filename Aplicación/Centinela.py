...
class modoVigilar():
    def __init__(self, parent):
        ...
        self.distancia_fijar = 40       #margen de distancia al centro para considerar la cara fijada
        ...
        self.roamX = 90 #primera posicion para el roam, la inicial
        self.roamY = 115
